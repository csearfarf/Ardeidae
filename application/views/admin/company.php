    ...
    <div class="wrapper ">
        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="#">Company</a>| Manage Company
                    </div>
                        ...
                        <div class="col-md-12">
                          <div class="card">
                            <div class="card-header card-header-primary">
                              ...
                              <p class="card-category">Registered Company that is responsible to manage the production in their company</p>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="row">
                                 ...
                                 <tr>
                                  ...
                                  <th class="text-center font-weight-bold h4">Address</th>
                                  <th class="text-center font-weight-bold h4">Contact Number</th>
                                  <th class="text-center font-weight-bold h4">Contract Address</th>
                    ...
                    <div class="modal-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="text" class="form-control" name="contractAddress" id="contractAddress"  placeholder="Enter Contract Number" required>
                          </div>
                        </div>
                        <div class="col-md-12">
                          <div class="form-group">
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                          <label>Company Name</label>
                          <input type="text" class="form-control" name="ename" id="ename" placeholder="Enter Company Name" required>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                          <label>Address</label>
                          <input type="text" class="form-control" name="eaddress" id="eaddress"  placeholder="Enter Company Address" required>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                          <label>Contact Number</label>
                          <input type="number" class="form-control" name="econtact" id="econtact"  placeholder="Enter Contact Number" required>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                          <label>Contract Address</label>
                          <input type="text" class="form-control" name="econtractAddress" id="econtractAddress"  placeholder="Enter Contract Number" required disabled>
                          </div>
                        </div>
                        <div class="col-md-12">
                          <div class="form-group">
            ...
            <footer class="footer">
              ...
              <script language="javascript" type="text/javascript" src="<?php echo base_url(); ?>scripts/adminCompany.js"></script>
