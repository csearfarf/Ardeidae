...
<body class="login-page">
						...
						<form class="form" id="loginForm">
							...
							<div class="col-12">
								<div class="col-lg-10 col-lg-offset-1">
									<h2 class="title color-gray" style="color: #555555;margin-bottom: 10px;">Login <br>Inspector</h2>
								</div>
							</div>
    ...
    <script src="<?php echo base_url()?>scripts/inspectorLogin.js" type="text/javascript"></script>
