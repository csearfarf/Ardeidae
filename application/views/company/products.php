    ...
    <div class="wrapper ">
        ...
        <div class="sidebar-wrapper">
            ...
            <ul class="nav">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="<?php echo base_url();?>company/products">
        ...
        <div class="main-panel">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                              <label for="exampleFormControlSelect1">Meat Type</label>
                              <select class="form-control selectpicker" data-style="btn btn-link" id="meattype" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                              <label for="exampleFormControlSelect1">Meat Category</label>
                              <select class="form-control selectpicker" data-style="btn btn-link" id="meatcategory" required>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                              <label class="label-control">Manufactured Date</label>
                              <input type="text" class="form-control datetimepicker" required id="manufacture"/>
                          </div>
                        </div>
                         <div class="col-md-6">
                          <div class="form-group">
                              <label class="label-control">Expiration Date</label>
                              <input type="text" class="form-control datetimepicker" required id="expiration"/>
                          </div>
                        </div>
            ...
            <footer class="footer">
              ...
              <script language="javascript" type="text/javascript" src="<?php echo base_url(); ?>scripts/companyProducts.js"></script>
